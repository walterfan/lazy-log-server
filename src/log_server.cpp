...
private:
    ...
    void process_request(http::request<request_body_t, http::basic_fields<alloc_t>> const& req)
    {
        ...
        {
        case http::verb::get:
            std::cout << "received get: " << req.target() << std::endl;
            BOOST_LOG_TRIVIAL(info) << req.target();
...
void init_logging()
{
    ...
    (
        keywords::file_name = "./log/log_server_%Y%m%d_%N.log",
...
int main(int argc, char* argv[])
{
    ...
    try
    {
        ...
        BOOST_LOG_TRIVIAL(info) << "start..." << std::endl;
